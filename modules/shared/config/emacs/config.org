...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Jon Bringhurst"
    user-mail-address "jon@bringhurst.org")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/jbringhu/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/jbringhu/bin" "/profile/bin" "/Users/jbringhu/.npm-packages/bin" "/Users/jbringhu/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
